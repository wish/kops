...
type ClusterSpec struct {
	...
	// DNZControllerGossipConfig for the cluster assuming the use of gossip DNS
	DNSControllerGossipConfig *GossipConfig `json:"dnsControllerGossipConfig,omitempty"`
